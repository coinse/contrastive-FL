...
list_project = [x for x in list_project if 'Lang' in x]
os.chdir(cur)
...
def format_code(code):
    result = subprocess.run(['C:\\Users\\COINSE\\Downloads\\astyle-3.6.6-x64\\astyle-3.6.6-x64\\astyle'], input=code, capture_output=True, text=True)
    return result.stdout

deprecated_bugs = ['Math_38', 'Lang_2']
#list_project = ['Time_27']
#list_project = ['Lang_55', 'Lang_45', 'Lang_35', 'Lang_25', 'Lang_15', 'Lang_5']
...
for project_name in tqdm(list_project):
    ...
    LOG_PATH = "./older_major/major_logs/"
    ...
    with open('complete_mutant_data_new.pkl', 'wb') as mf:
    ...
    with open('complete_method_data_new.pkl', 'wb') as mef:
    ...
    with open('complete_test_data_new.pkl', 'wb') as tf:
